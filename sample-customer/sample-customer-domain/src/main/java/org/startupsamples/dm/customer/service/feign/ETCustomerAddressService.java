...
package org.startupsamples.dm.customer.service.feign;
...
@FeignClient(contextId = "etCustomerAddress", name = CustomerDef.CUSTOMER_NAME, path = CustomerDef.CUSTOMER_PATH, configuration = StartupClientConfig.class, primary = false)
